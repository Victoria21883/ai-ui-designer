...
// Основная функция рендеринга (теперь рекурсивная)
async function renderComponent(component) {
    ...
    switch (type) {
        ...
        case 'card': {
            ...
            // Настройка базовых стилей контейнера
            frame.layoutMode = 'VERTICAL'; // По умолчанию вертикальный стек
            ...
            if (type === 'card') {
                ...
                frame.fills = []; // Прозрачный контейнер
            }
            // Рендерим детей рекурсивно
        ...
        case 'image': {
            ...
            // В реальном плагине тут можно было бы загрузить изображение через figma.createImage
            node = rect;
            break;
        }
        default: {
...
// Слушатель сообщений от UI плагина
